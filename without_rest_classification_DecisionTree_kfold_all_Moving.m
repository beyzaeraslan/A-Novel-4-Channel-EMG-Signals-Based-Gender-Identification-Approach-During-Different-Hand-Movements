%her bir hareket için bu kısmı değiştireceğiz. Çünkü burada amaç
%hareketlere göre cinsiyet sınıflandırması yapma.
%mesela kadın ve erkeğin birinci hareketini yükleyeceğiz. eğiteceğiz sonra
%ikinci hareketi... onuncu harekte kadar.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%ayrıca her hareketin ilk ve son cyclenına bakmak içinde eğitim
%gerçekleştireceğim. load kısmına da
%load('all_female_rms_second_move_matrix.mat')
%load('all_female_rms_last_move_matrix_last_cycle.mat') her hareket için
%tek tek yazıp eğitiyoruz.
